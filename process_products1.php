...
$sql = "INSERT INTO `product`(`product_id`, `product_name`, `product_description`, `product_image`, `categories`, `unit_price`, `available_quantity`, `created_at`, `updated_at`, `added_by`, `is_deleted`) 
		VALUES ('$product_id','$product_name','$product_desc','$product_image','$categories','$unit_price','$avb_quantity','$created_at','$updated_at','$added_by','$deleted')";
